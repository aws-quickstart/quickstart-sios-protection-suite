...
:quickstart-project-name: quickstart-sios-protection-suite
:partner-product-name: SIOS Protection Suite for Linux
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: SIOS Protection Suite
...
:quickstart-contributors: AWS Integration & Automation team
