...
** An Amazon Elastic Compute Cloud (Amazon EC2) Auto Scaling group of Linux bastion hosts to allow inbound SSH (Secure Shell) access to Amazon EC2 instances in public and private subnets.*
